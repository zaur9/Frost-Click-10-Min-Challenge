...
function gameLoop() {
  ...
  if (!isPaused && !isFrozen) {
    if (Math.random() < 0.012) createObject('green ornament', 'toy-green', 85 + Math.random() * 45);
if (Math.random() < 0.012) createObject('purple ornament', 'toy-purple', 85 + Math.random() * 45);
